...
export default function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      {/* Hero Section */}
      {/* CHANGE: Added responsive min-height and padding. 
          On mobile (portrait), we use 85vh and smaller padding to prevent 
          the text from pushing the video off-screen.
      */}
      <section className="relative min-h-[85vh] md:min-h-screen flex items-center justify-center overflow-hidden px-6 py-12 md:py-32">

        {/* Background Video */}
        <div className="absolute inset-0">
          <iframe
            /* CHANGE: Added `scale-[1.7]`. 
               On mobile portrait, this "zooms" the 16:9 video so it fills the vertical 
               space better, ensuring the drone/panels are visible behind the text.
               `md:scale-100` returns it to normal size for desktop.
            */
            className="w-full h-full object-cover object-center pointer-events-none scale-[1.7] md:scale-100"
          ...
          <div className="absolute inset-0 bg-gradient-to-b 
            from-white/70 via-white/45 to-white/70
            dark:from-slate-950/80 dark:via-slate-950/45 dark:to-slate-950/80" 
          />
        ...
        {/* Hero Content */}
        {/* CHANGE: Adjusted max-width on mobile to keep text from hitting screen edges */}
        <div className="relative z-10 w-full max-w-[90vw] md:max-w-5xl mx-auto text-center pt-10 md:pt-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 bg-amber-500 text-slate-950 font-medium rounded-full hover:bg-amber-400 transition-all duration-100"
            >
              View Services
